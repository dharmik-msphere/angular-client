...
@Component({
  selector: 'app-angular-lit',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './angular-lit.component.html',
  styleUrl: './angular-lit.component.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  imports: [CommonModule, FormsModule, BenchmarkPanelComponent],
})
export class AngularLitComponent implements OnInit, OnDestroy {
